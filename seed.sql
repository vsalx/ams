insert into users( name, city, email, password, type, created_at, updated_at) values ('Veselina Customer', 'София', 'customer@abv.bg', '$2y$10$4N6jfcAfHl.3a5Q.1YYX0..WuGMEwsDe6.cffyh9iI.sfzv5z7uRu', 'CUSTOMER', now(), now());
insert into users( name, city, email, password, type, created_at, updated_at) values ('Veselina Dentist', 'София', 'dentist@abv.bg', '$2y$10$4N6jfcAfHl.3a5Q.1YYX0..WuGMEwsDe6.cffyh9iI.sfzv5z7uRu', 'DENTIST', now(), now());
insert into users( name, city, email, password, type, created_at, updated_at) values ('Veselina Surgeon', 'Sofia', 'surgeon@abv.bg', '$2y$10$4N6jfcAfHl.3a5Q.1YYX0..WuGMEwsDe6.cffyh9iI.sfzv5z7uRu', 'SURGEON', now(), now());
